/**
 * web browser 의 indexedDB 를 핸들링 하기 위한 react 3rp party lib
 */
...
export const getBucketList = async () => {
  ...
  // db 에서 get 한 데이터가 없으면 임시 데이터를 생성하고 db 에 insert 한 후 그 데이터를 return
  if (!bucketList) {
...
export const getBucket = async (id) => {
  ...
  // bucketList 에서 데이터를 find 했는데 결과값이 null 이거나 undefined  인 경우도 있다
...
// browser 의 indexedDB 에 LOCAL_DB 이름으로 데이터 저장하기
