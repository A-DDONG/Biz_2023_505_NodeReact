...
console.log(typeof numZero); // num
...
// falsy falsey 형 데이라고 한다
if (!strNull) console.log("strNull 은", typeof strNull); // object
if (!strBlank) console.log("strBlank 는", typeof strBlank); // string
if (!numZero) console.log("numZero 는", typeof numZero); // num
if (!valUndefined) console.log("valUndefined 는", typeof valUndefined); // undefined
...
if (num === 0) {
  ...
  console.log("Num 는 0이 아니다");
}
if (!num) console.log("진짜로 Num 는 0이네");

const strName = null;
if (!strName) console.log("이름이 없어요");
if (strName === null || strNum === "") console.log("이름이 진짜 없네");
